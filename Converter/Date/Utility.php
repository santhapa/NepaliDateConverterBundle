...
class Utility{
      ...
      public static $nepaliDates = array(
	...
	public static function isLeapYear($year)
	{
      ...
      public static function formatResult($date)
      {
            switch ($date['format']) 
            {
                  ...
                  case DateFormat::MM_DD_YYYY:
                        $res = $date['num_month'].'-'.$date['day'].'-'.$date['year'];
                        break;
                  ...
                  case DateFormat::DD_MMM_YYYY:
                        $res = $date['day'].'-'.strtoupper(substr($date['alpha_month'],0,3)).'-'.$date['year'];
                        break;

                  case DateFormat::MMM_DD_YYYY:
                        $res = strtoupper(substr($date['alpha_month'],0,3)).'-'.$date['day'].'-'.$date['year'];
                        break;

                  case DateFormat::DD_MMMM_YYYY:
                        $res = $date['day'].' '.$date['alpha_month'].', '.$date['year'];
                        break;

                  case DateFormat::MMMM_DD_YYYY:
                        $res = $date['alpha_month'].' '.$date['day'].', '.$date['year'];
                        break;

                  case DateFormat::DD_MMMM_YYYY_W:
                        $res = $date['day'].' '.$date['alpha_month'].', '.$date['year'].' ('.$date['alpha_weekDay'].')';
                        break;

                  case DateFormat::MMMM_DD_YYYY_W:
                        $res = $date['alpha_month'].' '.$date['day'].', '.$date['year'].' ('.$date['alpha_weekDay'].')';
                        break;
